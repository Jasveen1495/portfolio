...
const ProjectCard = ({ orientation = "land", flexPos, data }) => {
   return (
      <div className={`w-full flex ${orientation === "por" ? "scale-90" : window.innerHeight < 850 ? "md:h-[40vh]" : "md:h-[30vh]"} ${orientation === "por" ? "" : flexPos % 2 !== 0 ? "md:justify-end" : "md:justify-start"} mt-10 md:mb-16 last:mb-8 `}>
