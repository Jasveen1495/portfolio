   ...
   return (
      <div className='w-full px-10 md:px-0 flex py-7 justify-center bg-backGrey'>
         <div className='w-full flex flex-col md:w-[70%]'>
            <a href='mailto:kjasveen23@gmail.com' target='_blank' rel='noreferrer' className='font-medium underline text-3xl'>kjasveen23@gmail.com</a>
            <p className='md:w-[60%] my-7'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam dapibus justo sed leo consectetur aliquet eget a lorem. </p>
            <div className='flex'>
